...
import './TermsPage.css'; // Import dedicated CSS
        ...
        <div className="terms-page-wrapper">
            ...
            <div className="terms-container">
                <div className="terms-header">
                    ...
                    <p className="terms-subtitle">Terms and Conditions for Using The Vanity India</p>
                    <p className="terms-updated">Last Updated: January 2025</p>
                </div>

                <PageToc sections={tocSections} />

                <div className="terms-content" id="main-content">
                    <section className="terms-section" data-toc-id="acceptance">
                    ...
                    <section className="terms-section" data-toc-id="license">
                        <h2>Use License</h2>
                        <p>
                    ...
                    <section className="terms-section" data-toc-id="registration">
                    ...
                    <section className="terms-section" data-toc-id="product-info">
                    ...
                    <section className="terms-section" data-toc-id="orders-payment">
                    ...
                    <section className="terms-section" data-toc-id="shipping">
                    ...
                    <section className="terms-section" data-toc-id="returns">
                    ...
                    <section className="terms-section" data-toc-id="prohibited">
                    ...
                    <section className="terms-section" data-toc-id="intellectual">
                    ...
                    <section className="terms-section" data-toc-id="disclaimer">
                        <h2>Disclaimer</h2>
                        <p>
